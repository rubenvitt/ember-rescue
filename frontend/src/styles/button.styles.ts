...
export const styles: {
  ...
  colors: {
    ...
    primary: [
      'text-white [--btn-hover-overlay:var(--color-gray-800)]/10 [--btn-bg:var(--color-primary-600)] [--btn-border:var(--color-primary-600)]/90',
...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      intent: {
        ...
        outline: [
          ...
          'data-active:bg-current/[2.5%] data-hover:bg-current/[2.5%]',
          'dark:[--btn-bg:transparent] dark:data-active:bg-current/5 dark:data-hover:bg-current/5',
        ],
        plain: [
    ...
    //@ts-ignore
    compoundVariants: [
      // Define compound variants for each color and intent combination
      ...Object.keys(styles.colors).flatMap((color: ButtonColor) => {
        return [
          { intent: 'solid', color, class: styles.colors[color] },
          {
            intent: 'outline',
            color,
            class: [
              `text-${color}-700 border-current`,
              `dark:text-${color}-300`,
              `[--btn-icon:theme(colors.${color}.500)]`,
              `data-active:[--btn-icon:theme(colors.${color}.700)] data-hover:[--btn-icon:theme(colors.${color}.700)]`,
              `dark:data-active:[--btn-icon:theme(colors.${color}.400)] dark:data-hover:[--btn-icon:theme(colors.${color}.400)]`,
            ],
          },
        ];
      }),
