...
export const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  ({ color, className, ...props }, ref) => {
    return (
      <span
        ref={ref}
        className={twMerge(badgeStyles({ color }), className)}
        {...props}
      />
    );
  },
...
export const BadgeButton = forwardRef<HTMLElement, BadgeButtonProps>(
  ({ color = 'zinc', className, children, ...props }, ref) => {
    const classes = twMerge(badgeButtonStyles(), className);
