        ...
        <DialogPanel className={modalPanel({ variant, fullWidth })}>
          <div className={modalHeader({ panelColor })}>
            <div className="sm:flex sm:items-start">
              {Icon && (
                <div
                  className={`mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-${panelColor}-100 sm:mx-0 sm:h-10 sm:w-10`}>
                  <Icon className={`h-6 w-6 text-${panelColor}-600`} aria-hidden="true" />
                </div>
              )}
