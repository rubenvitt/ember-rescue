  ...
  return (
    ...
    >
      ...
      <div className="relative mt-2">
        <ComboboxInput
          className={clsx(
            'w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 shadow-sm ring-inset ring-1 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6',
            hasErrors ? 'ring-red-500 focus:ring-red-500 placeholder:text-red-300 text-red-900' : 'text-gray-900 ring-gray-300 focus:ring-indigo-600',
          )}
