...
-- AddForeignKey
ALTER TABLE "Einheit" ADD CONSTRAINT "Einheit_aktuellerStatusId_fkey" FOREIGN KEY ("aktuellerStatusId") REFERENCES "Status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinheitStatusHistorie" ADD CONSTRAINT "EinheitStatusHistorie_bearbeiterId_fkey" FOREIGN KEY ("bearbeiterId") REFERENCES "Bearbeiter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinheitStatusHistorie" ADD CONSTRAINT "EinheitStatusHistorie_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "Status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinheitStatusHistorie" ADD CONSTRAINT "EinheitStatusHistorie_einsatzId_fkey" FOREIGN KEY ("einsatzId") REFERENCES "Einsatz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinheitStatusHistorie" ADD CONSTRAINT "EinheitStatusHistorie_einheitId_fkey" FOREIGN KEY ("einheitId") REFERENCES "Einheit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "Einsatz" ADD CONSTRAINT "Einsatz_bearbeiterId_fkey" FOREIGN KEY ("bearbeiterId") REFERENCES "Bearbeiter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatzEinheit" ADD CONSTRAINT "EinsatzEinheit_einheitId_fkey" FOREIGN KEY ("einheitId") REFERENCES "Einheit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatzEinheit" ADD CONSTRAINT "EinsatzEinheit_einsatzId_fkey" FOREIGN KEY ("einsatzId") REFERENCES "Einsatz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatzEinheitPerson" ADD CONSTRAINT "EinsatzEinheitPerson_personId_fkey" FOREIGN KEY ("personId") REFERENCES "Person"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatzEinheitPerson" ADD CONSTRAINT "EinsatzEinheitPerson_einsatzEinheitId_fkey" FOREIGN KEY ("einsatzEinheitId") REFERENCES "EinsatzEinheit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatztagebuchEintrag" ADD CONSTRAINT "EinsatztagebuchEintrag_einsatzId_fkey" FOREIGN KEY ("einsatzId") REFERENCES "Einsatz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "EinsatztagebuchEintrag" ADD CONSTRAINT "EinsatztagebuchEintrag_bearbeiterId_fkey" FOREIGN KEY ("bearbeiterId") REFERENCES "Bearbeiter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "PersonQualifikation" ADD CONSTRAINT "PersonQualifikation_qualifikationId_fkey" FOREIGN KEY ("qualifikationId") REFERENCES "Qualifikation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "PersonQualifikation" ADD CONSTRAINT "PersonQualifikation_personId_fkey" FOREIGN KEY ("personId") REFERENCES "Person"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
VALUES (generate_cuid(), '1', 'Einsatzbereit auf Funk',
       ...
       (generate_cuid(), '3', 'Einsatzübernahme (ausgerückt)',
        ...
        CURRENT_TIMESTAMP),
       (generate_cuid(), '4', 'Einsatzort (vor Ort)', 'Einheit ist am Einsatzort eingetroffen und führt den Einsatz durch',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (generate_cuid(), '5', 'Sprechwunsch', 'Einheit wünscht Kontakt zur Leitstelle für nicht dringende Kommunikation',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO "Qualifikation" (id, bezeichnung, abkuerzung, "createdAt", "updatedAt")
